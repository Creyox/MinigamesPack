...
if CLIENT then
  MINIGAME.lang = {
    ...
    desc = {
      English = "Oh no, the adblocker failed!"
    }
  }
else 
  util.AddNetworkString("adblocker_minigame_clientpopupopen")
end

if SERVER then

  function MINIGAME:OnActivation() 
    timer.Create("adblocker_minigame_popuptimer", 10, 0, function()
      local plys = util.GetAlivePlayers()
      local randomNumber = math.random(1, #plys)
      plys[randomNumber]:EmitSound("error.wav")
      net.Start("adblocker_minigame_clientpopupopen")
      net.Send(plys[randomNumber])
    end)
  end

  function MINIGAME:OnDeactivation()
    timer.Remove("adblocker_minigame_popuptimer")
  end
...
if CLIENT then
  function MINIGAME:OnActivation()
    net.Receive("adblocker_minigame_clientpopupopen", function(len , ply)
      local kraken = math.random (1,600)    
      ...
      if kraken <= 599 then
          ...
          if popupnumber == 1 then
            ...
            norton:SetImage("materials/vgui/ttt/popups/norton.png")
            norton:SetPos(0,0)
          ...
          elseif popupnumber == 2 then
            ...
            areyouretarded:SetImage("materials/vgui/ttt/popups/adareyouretarded.png")
          ...
          elseif popupnumber == 3 then
            ...
            iphonepopup:SetImage("materials/vgui/ttt/popups/iphonescampopup.png")
          ...
          elseif popupnumber == 4 then
            ...
            infected:SetImage("materials/vgui/ttt/popups/infected.png")
            infected:SetPos(0,0)
          ...
          elseif popupnumber == 5 then
            ...
            single:SetImage("materials/vgui/ttt/popups/single.png")
            single:SetPos(0,0)
          ...
          elseif popupnumber == 6 then
            ...
            wannacry:SetImage("materials/vgui/ttt/popups/wannacry.png")
            wannacry:SetPos(0,0)
          ...
          elseif popupnumber == 7 then
            ...
            stupid:SetImage("materials/vgui/ttt/popups/stupid.png")
            stupid:SetPos(0,0)
          ...
          elseif popupnumber == 8 then
            ...
            robuxscam:SetImage("materials/vgui/ttt/popups/robuxscam.png")
          ...
          elseif popupnumber == 9 then
            ...
            freevbucks:SetImage("materials/vgui/ttt/popups/freevbucks.png")
          ...
          elseif popupnumber == 10 then
            ...
            discscam:SetImage("materials/vgui/ttt/popups/discordscam.png")
            discscam:SetPos(0,0)
      ...
      elseif kraken == 600 then
          local krakenlogo = vgui.Create("DFrame")
          local poskrak1 = math.random(1,ScrW()-899)
          local poskrak2 = math.random(1,ScrH()-504)
          krakenlogo:SetPos(poskrak1,poskrak2)
          krakenlogo:SetSize(899,504)
          krakenlogo:ShowCloseButton(false)
          krakenlogo:MakePopup()
          
          local krakenlogo1 = vgui.Create("DImage", krakenlogo)
          krakenlogo1:SetImage("materials/vgui/ttt/popups/Krakenlogo.png")
          krakenlogo1:SetPos(0,0)
          krakenlogo1:SetSize(899,504)
          
          local closebutton11 = vgui.Create("DButton" , krakenlogo)
          closebutton11:SetSize(200,70)
          closebutton11:SetPos(350,385)
          closebutton11:SetText("Great server. Close popup")
          closebutton11.Paint = function(s , w , h )
          draw.RoundedBox(5,0,0, w, h, Color(255,255,255))
          end    
          closebutton11.DoClick = function()
            krakenlogo:Close()
          end
